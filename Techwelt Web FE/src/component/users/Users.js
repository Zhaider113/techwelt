  ...
  useEffect(() => {
    setData(
      userList?.filter((item) => {
        return (!searchNameText || item.fname.toLocaleLowerCase().includes(searchNameText.toLocaleLowerCase())) 
          ...
          && (!searchStatusText || searchStatusText === "Status" || (searchStatusText === "Active" && item.verified) || (searchStatusText === "Deactivated" && !item.verified));
      })
    )
  }, [searchNameText, searchUserNameText, searchEmailText, searchStatusText, userList, searchRoleText])
        ...
        <div className="d-flex flex-column justify-content-center align-items-center">
          <div className="sub1-div1 d-flex justify-content-between align-items-center w-100">
            ...
            <div className="d-flex">
              ...
              <div className="tab-button d-flex justify-content-evenly align-items-center mx-1" onClick={() => navigate("/AddUser")}>
                  ...
                  return (
                    <div id="import-users" key={index}>
                      ...
                      <div className="subsub1-sub2-users-div2">
                        <div className="item">
                          <img style={{borderRadius: '30rem'}} crossOrigin='*' src={item.image ? process.env.REACT_APP_URL + '/' + item.image : './assets/common_user.png'} alt="none" className="person object-fit-cover item" />
                        </div>
                        ...
                        >
                          {item?.verified === true ? "Activated" : "Deactivated"}
                        </p>
                          ...
                          <div className="dropdown-menu users-dropdown-div">
                            <div className="sub1-users-dropdown-div mx-4 d-flex flex-column justify-content-evenly h-100">
                              ...
                              <div
                                ...
                                onClick={() => handleDialogBoxUserState(userStatus, item?.email)}
                              >
                                <img
                                  src={
                                    item.verified === false
                                  ...
                                  alt="none"
                                />
                                <p className="mb-0 ml-2">{item.verified === true ? "Deactivate" : "Active"}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div id="import-users" key={index}>
                  ...
                  <div className="subsub1-sub2-users-div2 d-flex align-items-center py-2">
                    <div className="item col-2 align-items-start px-1">
                      <img crossOrigin='*' src={item.image ? process.env.REACT_APP_URL + '/' + item.image : './assets/common_user.png'} alt="none" className="person item object-fit-cover" />
                    </div>
                    <div className="d-flex flex-column col-10 px-2">
                      <div className="d-flex">
                        <p className="mb-0 px-2 col-4 text-white">Name</p>
                        <p className="mb-0 px-2 col-8 item justify-content-start">{item?.fname}</p>
                      </div>
                      <div className="d-flex">
                        <p className="mb-0 px-2 col-4 text-white">Username</p>
                        <p className="mb-0 px-2 col-8 item justify-content-start">{item?.lname}</p>
                      </div>
                      <div className="d-flex">
                      ...
                      <div className="d-flex">
                        ...
                        <p className="mb-0 px-2 col-8 item justify-content-start">{item?.phone}</p>
                      </div>
                      <div className="d-flex">
                      ...
                      <div className="d-flex">
                        ...
                        <p className="mb-0 px-2 col-8 item justify-content-start">{item?.role}</p>
                      </div>
                      <div className="d-flex">
                        <p className="mb-0 px-2 col-4 text-white">Country</p>
                        <p className="mb-0 px-2 col-8 item justify-content-start">{item?.country}</p>
                      </div>
                      <div className="d-flex">
