        ...
        <div className='sub1-auth-right'>
          <div className='main-form d-flex justify-content-center align-items-center'>
            <div className='subsub1-sub1-auth-right'>
              ...
              <span className='forgot-password' onClick={() => navigate("/Forgot")}>Forgot Password?</span>
              <button className='py-1' onClick={() => { signIn(); setFade(true); }}>
                {!fade ? 'Login' : <img src='./assets/loading.gif' className="imgloading" alt='none' />}
              </button>
              <button className='py-1' onClick={() => { navigate("/Signup"); }}>SignUp</button>
            </div>
          </div>
          <div className='subsub2-sub1-auth-right mt-5'>
            <a href='https://www.google.com' target='_blank' rel="noreferrer"><img src='./assets/Google.svg' alt='none' style={{ width: "12.6rem", height: "4.4rem" }} /></a>
            <a href='https://www.facebook.com' target='_blank' rel="noreferrer"><img src='./assets/Facebook.svg' alt='none' style={{ width: "12.6rem", height: "4.4rem", marginLeft: "1rem" }} /></a>
          </div>
        </div>
      </div>
    </div>
